        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Icon(Icons.install_mobile, color: AppColors.primary, size: 40),
              const SizedBox(height: 12),
              const Text('Experience Kuryentahin \u26a1', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
